      ...
      <div className="flex flex-col items-start justify-start h-full">
        <div className="text-left w-full max-w-md mx-auto">
          ...
          <div className="flex items-center gap-3 mb-4">
            <img src="/logo.png" alt="Honda Logo" className="h-8 w-auto sm:h-10" />
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold">
              Muzaffarpur Honda
            </h1>
          </div>
          <p className="text-base sm:text-lg md:text-xl mb-4">Sales | Services</p>
          ...
          <div className="space-y-3">
            <p className="flex items-start sm:items-center text-xs sm:text-sm md:text-base">
              ...
              <span>Muzaffarpur Honda, NH28 opposite Science College, Gobarsahi, Muzaffarpur.</span>
            </p>
